...
<head>
    ...
    @vite(['resources/css/Ale.css','resources/css/ValidarCorreo.css','resources/js/ValidarCorreo.js'])
</head>
<body>    
    <!-- ====================== ALERTA ====================== -->
    ...
    <div class="contenedor">
        <div class="d-flex align-items-center p-3 mb-4">
            ...
            <h2 class="fs-4">Validar correo</h2>
        </div>
        <div class="p-3 h-100">
            <div class="d-flex justify-content-center mt-1 px-5 mt-md-5">
                <input id="txtEmpleadoCorreo" type="email" class="input-base form-control"placeholder="ejemplo@correo.com">
            </div>
            <div class="d-flex justify-content-center mt-4">
                <button id="btnValidarCorreo" class="boton-dos">Validar Correo</button>
